...
export class SublocationComponent implements OnInit {
  ...
  constructor(private matDialog: MatDialog, private _subLocationService: SubLocationService, private _snackBarService: CustomSnackBarService, private _sharedService: SharedService) { }
